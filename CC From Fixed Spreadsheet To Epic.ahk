...
Else ; If none of the above "If" staements work then a message box is displayed stating the Charge Code that needs to be added to this script, adds charge code to Clipboard and then exits script
{
...
Send, {Space}{Tab 3}
Sleep 500
Send, 027200000 ; Nine Digit ChargeMaster Charge Code in column I
Sleep 500
