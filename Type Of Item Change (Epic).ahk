...
xcl.Range("B"Row).Interior.ColorIndex := 6 ; Turns the backround of the cell yellow - Being worked on
...
xcl.Range("B"Row).Interior.ColorIndex := 4 ; Turns the backround of the cell green - Completed
...
Send, !a
xcl.Range("A"Row).Interior.ColorIndex := 4 ; Turns the backround of the cell green - Completed
xcl.Act#Requires Autohotkey v1.1.09+iveWindow.SmallScroll(1,0,0,0)
Row := Row + 1
ColumnA := xcl.Range("A"Row).text
If(ColumnA = "")
{
